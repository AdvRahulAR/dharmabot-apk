...
export default function DocumentDraftingScreen() {
  ...
  const exportToDOCX = async () => {
    ...
    // For now, we'll export as TXT since DOCX requires server-side processing
    Alert.alert(
      'Export Format',
      'DOCX export requires server processing. Would you like to export as TXT instead?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Export TXT', onPress: exportToTXT }
      ]
    );
  };
        ...
        <View style={[styles.section, isDark && styles.sectionDark]}>
          ...
          <View style={styles.exportButtons}>
            ...
            <TouchableOpacity
              ...
              disabled={!documentContent.trim()}
            >
              <Text style={styles.exportButtonText}>Export DOCX</Text>
            </TouchableOpacity>
          </View>
